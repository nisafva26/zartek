...
//
//     final restuarant = restuarantFromJson(jsonString);

import 'dart:convert';

List<Restuarant> restuarantFromJson(String str) => List<Restuarant>.from(json.decode(str).map((x) => Restuarant.fromJson(x)));

String restuarantToJson(List<Restuarant> data) => json.encode(List<dynamic>.from(data.map((x) => x.toJson())));
